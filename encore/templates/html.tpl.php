...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <?php if ($add_respond_js): ?>
    <!--[if lt IE 9]>
    <script src="<?php print $base_path . $path_to_encore; ?>/js/html5-respond.js"></script>
    <![endif]-->
  <?php elseif ($add_html5_shim): ?>
    <!--[if lt IE 9]>
    <script src="<?php print $base_path . $path_to_encore; ?>/js/html5.js"></script>
    <![endif]-->
  <?php endif; ?>
</head>
